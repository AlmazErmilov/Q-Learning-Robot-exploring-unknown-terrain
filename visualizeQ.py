...
if __name__ == "__main__":
    ...
    #bg_image = pygame.image.load("map.jpg") # Uncomment to load the terrain map image.
    ...
    while running:
        ...
        pygame.draw.rect(play_surface, black_color, Rect(robot.get_x() * 70 + 69, robot.get_y() * 70 + 69, 22, 22)) # Black outline.
